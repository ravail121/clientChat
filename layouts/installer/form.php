<div class="installation_form d-none">
    <form>
        ...
        <div class="form-group mb-3">
            <label class="mb-2">Purchase Code | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></label>
            <input type="text" name="purchase_code" class="form-control" placeholder="Enter random value" />
        </div>
