...
$columns = [
    ...
    'site_roles.role_hierarchy', 'site_roles.site_role_attribute'
];
...
if (isset($user[0])) {
    ...
    if (Registry::load('current_user')->logged_in) {
        ...
        } else if (role(['permissions' => ['profile' => 'edit_profile']]) && $higher_role_hierarchy) {
            $output['button'] = new stdClass();
            $output['button']->class = 'button';
    ...
    if ((int)$user_id !== (int)Registry::load('current_user')->id) {
        ...
        if (role(['permissions' => ['site_users' => 'edit_users']]) && $higher_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'approve_users']]) && $higher_role_hierarchy) {
        ...
        if (role(['permissions' => ['site_users' => 'unban_users_from_site']]) && $higher_role_hierarchy) {
        ...
        if (role(['permissions' => ['site_users' => 'ban_users_from_site']]) && $higher_role_hierarchy) {
            if ($user['site_role_attribute'] !== 'banned_users') {
                $output['options'][$option_index] = new stdClass();
                $output['options'][$option_index]->class = 'ask_confirmation';
                $output['options'][$option_index]->attributes['data-update'] = 'site_user_role';
        ...
        if (role(['permissions' => ['site_users' => 'ban_ip_addresses']]) && $higher_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'unban_ip_addresses']]) && $higher_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'delete_users']]) && $higher_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
    ...
    if (role(['permissions' => ['site_users' => 'manage_user_access_logs']]) && $higher_role_hierarchy) {
        $output['options'][$option_index] = new stdClass();
    ...
    if (role(['permissions' => ['profile' => 'view_phone_number']])) {
        if (!empty($user['phone_number'])) {
            ...
            $output['content'][6]->field['title'] = Registry::load('strings')->phone_number;
            $output['content'][6]->field['value'] = $user['phone_number'];

            if (!empty($user['phone_verified'])) {
                $output['content'][6]->field['title_img'] = Registry::load('config')->site_url.'assets/files/defaults/verified.png';
            }
        }
    ...
    if (role(['permissions' => ['profile' => 'view_profile_url']])) {
        ...
        $output['content'][7]->field['title'] = Registry::load('strings')->profile_url;
        $output['content'][7]->field['value'] = Registry::load('config')->site_url.$user['username'].'/';
        $output['content'][7]->field['link'] = $output['content'][7]->field['value'];
    }
    ...
    if ($friends) {
        if (isset($check_friend_list[0])) {
            ...
            $output['content'][4]->field['value'] = get_date($friends_since)['date'];
        }
    }
